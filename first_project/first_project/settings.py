...
SECRET_KEY = 'django-insecure-!ck420$%vf7-)w!x9q$pv%s8muywigel60p6=0*_vt+p4^^vgp'
...
# Uncomment below for MySQL when your server is running
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.mysql',
#         'NAME': 'alx_db',      # Replace with your MySQL database name
#         'USER': 'root',      # Replace with your MySQL username
#         'PASSWORD': 'Betrand1738',  # Replace with your MySQL password
#         'HOST': 'localhost',
#         'PORT': '3306',
#     }
# }
